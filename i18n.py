...
_STRINGS = {
    "en": {
        ...
        "err_no_creds_title": "Not signed in",
        "err_no_creds_detail": "Run `claude login` in Terminal to connect your Claude Code account.",
    ...
    "ru": {
        ...
        "err_no_creds_title": "Не авторизовано",
        "err_no_creds_detail": "Выполни `claude login` в терминале, чтобы подключить аккаунт Claude Code.",
    ...
    "es": {
        ...
        "err_no_creds_title": "No has iniciado sesión",
        "err_no_creds_detail": "Ejecuta `claude login` en la Terminal para conectar tu cuenta de Claude Code.",
    ...
    "de": {
        ...
        "err_no_creds_title": "Nicht angemeldet",
        "err_no_creds_detail": "Führe `claude login` im Terminal aus, um dein Claude-Code-Konto zu verbinden.",
    ...
    "fr": {
        ...
        "err_no_creds_title": "Non connecté",
        "err_no_creds_detail": "Exécutez `claude login` dans le Terminal pour connecter votre compte Claude Code.",
    ...
    "pt": {
        ...
        "err_no_creds_title": "Não conectado",
        "err_no_creds_detail": "Execute `claude login` no Terminal para conectar sua conta do Claude Code.",
    ...
    "ja": {
        ...
        "err_no_creds_title": "サインインしていません",
        "err_no_creds_detail": "ターミナルで `claude login` を実行して Claude Code アカウントを接続してください。",
    ...
    "zh": {
        ...
        "err_no_creds_title": "尚未登录",
        "err_no_creds_detail": "请在终端中运行 `claude login` 以连接您的 Claude Code 账户。",
