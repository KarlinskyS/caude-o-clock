...
_STRINGS = {
    "en": {
        ...
        "err_no_creds": "Claude Code credentials not found in Keychain. Run `claude login` at least once.",
    ...
    "ru": {
        ...
        "err_no_creds": "Не нашёл креды Claude Code в Keychain. Выполни `claude login` хотя бы раз.",
    ...
    "es": {
        ...
        "err_no_creds": "No se encontraron credenciales de Claude Code en Keychain. Ejecuta `claude login` al menos una vez.",
    ...
    "de": {
        ...
        "err_no_creds": "Keine Claude-Code-Anmeldedaten im Schlüsselbund gefunden. Führe mindestens einmal `claude login` aus.",
    ...
    "fr": {
        ...
        "err_no_creds": "Identifiants Claude Code introuvables dans le trousseau. Exécutez `claude login` au moins une fois.",
    ...
    "pt": {
        ...
        "err_no_creds": "Credenciais do Claude Code não encontradas no Keychain. Execute `claude login` pelo menos uma vez.",
    ...
    "ja": {
        ...
        "err_no_creds": "Keychain に Claude Code の認証情報が見つかりません。`claude login` を一度実行してください。",
    ...
    "zh": {
        ...
        "err_no_creds": "在钥匙串中未找到 Claude Code 凭据。请至少运行一次 `claude login`。",
